...
public class LibrarianTest
{
  ...
  @Test void get_ssn_returns_ssn()
  {
    librarian=new Librarian(1234567890,"password","Pepito","Perez");
    assertEquals(1234567890,librarian.getSsn());
  }

  @Test void get_password_returns_password()
  {
    librarian=new Librarian(1234567890,"password","Pepito","Perez");
  ...
  @Test void set_date_of_employment_to_a_future_date_sets_the_date_normally()
  {
    librarian=new Librarian(1234567890,"password","Pepito","Perez");
