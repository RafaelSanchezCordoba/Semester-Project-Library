...
class LoanMagazineTest {
    ...
    @Test void create_new_loan_magazine_with_all_correct_parameters(){
        loanMagazine = new LoanMagazine(1,"123456789");
        assertEquals("0 1 2022-05-23 123456789",loanMagazine.toString());
    }

    @Test void create_new_loan_magazine_with_empty_ssn_number(){
        loanMagazine = new LoanMagazine(1,"");
        assertEquals("0 1 2022-05-23 ",loanMagazine.toString());
    }

    @Test void create_new_loan_magazine_with_null_ssn_number(){
        loanMagazine = new LoanMagazine(1,null);
        assertEquals("0 1 2022-05-23 null",loanMagazine.toString());
    }
    ...
    @Test void get_end_date_of_loan_magazine(){
        loanMagazine = new LoanMagazine(0,"123456789");
